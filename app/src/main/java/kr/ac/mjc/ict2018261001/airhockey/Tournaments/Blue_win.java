...
public class Blue_win extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.blue_win);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.home:
                        Intent intent = new Intent(Blue_win.this, MainActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.setting:
                        Intent intent2 = new Intent(Blue_win.this, SettingActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.support:
                        Intent intent3 = new Intent(Blue_win.this, SupportActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.about_us:
                        Intent intent4 = new Intent(Blue_win.this, InfoActivity.class);
                        startActivity(intent4);
                        break;
                    case R.id.share:
                        Intent intent6 = new Intent(Blue_win.this, ShareActivity.class);
                        startActivity(intent6);
                        break;
                    case R.id.game:
                        Intent intent1 = new Intent(Blue_win.this, TournamentFinal.class);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.home:
                        Intent intent8 = new Intent(Blue_win.this, MainActivity.class);
                    ...
                    case R.id.game:
                        ...
                        break;
                    case R.id.setting:
                        Intent intent11 = new Intent(Blue_win.this, SettingActivity.class);
